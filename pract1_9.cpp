...
int main(){
    ...
    for (int i = 0; i < size; i++){
        ...
        cout << "кол-во часов, ставка, преми€: ";
        cin >> hours >> rate >> prem;
    ...
    cout << "максимальна€ из зарплат и номер получившего ее работника: " << max_element_num(salary, size) << endl;
    cout << "количество работников, получивших на руки более 50000 руб и их номера: "<< bigger_el_num(salary, 50000, size) << endl;
    cout << "обща€ сумма налога, уплаченного всей бригадой: "<< sum(nalogi, size);
    delete[] salary;
    delete[] nalogi;
